...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        createPersonnage("Napoléon Bonaparte", "Homme", "France", "Europe", "Politicien", "18e-19e siècle","“Les hommes de génie sont des météores destinés à brûler pour éclairer leur siècle”","51 ans","Empereur des Français");
        createPersonnage("Leonard de Vinci", "Homme", "Italie", "Europe", "Artiste", "15e-16e siècle","“Nul conseil n'est plus loyal que celui qui se donne sur un navire en péril”","67 ans","Maître de la Renaissance");
        createPersonnage("Cléopâtre", "Femme", "Égypte", "Afrique", "Dirigeant", "1er siècle av. J.-C.","Je suis une personne qui ne possède pas citation connue","39 ans","Reine d'Égypte");
        createPersonnage("Galilée", "Homme", "Italie", "Europe", "Scientifique", "16e-17e siècle","“On ne peut rien apprendre aux gens. On peut seulement les aider à découvrir qu’ils possèdent déjà en eux tout ce qui est à apprendre”","77 ans","Père de la science Moderne");
        createPersonnage("Einstein", "Homme", "Allemagne", "Europe", "Scientifique", "19e-20e siècle","“Que chacun raisonne en son âme et conscience, qu'il se fasse une idée fondée sur ses propres lectures et non d'après les racontars des autres”","71 ans","Fondateur de la relativité");
        ...
        createPersonnage("Hô Chi Minh", "Homme", "Vietnam", "Asie", "Dirigeant", "20e", "“Rien n'est plus précieux que l'indépendance et la liberté.”", "79 ans", "Père de l'indépendance vietnamienne");
    ...
    private void createPersonnage(String nom, String genre, String pays, String continent, String domaine, String periode, String citation, String indiceDescription1 ,String indiceDescription2) {
        Personnage personnage = new Personnage(nom, genre, pays, continent, domaine, periode, citation);
        Indice indice = new Indice(personnage, indiceDescription1);
        ...
        logger.info("Personnage {} avec indice {} ajouté à la base de données", nom, indiceDescription1,indiceDescription2);
    }
}
